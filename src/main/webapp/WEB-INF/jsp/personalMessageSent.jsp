        ...
        <div class="column col-3">
            <nav class="sidebar">
                <ul class="nav flex-column p-3">
	                ...
	                <li class="nav-item">
		                <a class="nav-link sidebar-link" id="current" href="/personalMessageSent">Küldött üzenetek</a>
	                </li>
                </ul>
            </nav>
        </div>
                            ...
                            <tr>
                                ...
                                <c:forEach items="${messages}" var="m">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="personalMessageCalls/openSent?id=${m.id}" class="btn btn-info sm">Olvasás</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                        </table>
