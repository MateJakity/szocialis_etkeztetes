                ...
                <div class="container-sm">
                    <table class="table table-striped">
                       <tr>
                         ...
                         <th>
                            Maximális befogadóképesség(kg)
                         </th>
                         <th>
                            Jelenlegi tartalom(kg)
                         </th>
                         <c:if test="${sessionScope.adminRoleType == 'true' || sessionScope.warehouseRoleType == 'true'}">
                            <th>
                                Törlés
                       ...
                       <c:forEach items="${warehouses}" var="w">
                        <tr>
                            ...
                            <td>
                                ${w.currentQuantity} kg
                            </td>
                            <c:if test="${sessionScope.adminRoleType == 'true' || sessionScope.warehouseRoleType == 'true'}">
                                <td>
                                    <a onclick='return confirm("Biztosan törölni szeretné a raktárat?");' href="${pageContext.request.contextPath}/warehouseHandling/warehouseDelete?id=${w.id}" class="btn btn-danger sm">Törlés</a>
                                </td>
                                <td>
                                    <a href="${pageContext.request.contextPath}/warehouseHandling/warehouseUpdate?id=${w.id}" class="btn btn-warning sm">Módosítás</a>
                                </td>
                            </c:if>
                            <td>
                                <a href="${pageContext.request.contextPath}/warehouseHandling/productsInWarehouse?id=${w.id}" class="btn btn-info sm">Készlet</a>
                            </td>
                        </tr>
                       </c:forEach>
                    </table>
