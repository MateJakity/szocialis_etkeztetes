    ...
    <div class="row">
            ...
            <nav class="sidebar">
                <ul class="nav flex-column p-3">
	                ...
	                <c:if test="${sessionScope.adminRoleType == 'true' || warehouseRoleType == 'true'}">
                        <li class="nav-item">
                            <a class="nav-link sidebar-link" id="current" href="${pageContext.request.contextPath}/warehouseNew"> Új Raktár hozzáadása</a>
                        </li>
                    </c:if>
                    <li class="nav-item">
        ...
        <div class="column col-9">
            <div class="container-sm">
                <form action="warehouseNew" method="post">
                    <label class="form-label fw-bold" for="name">Raktár neve</label>
                    <br>
                    <input class="form-control" type="text" id="name" name="name" placeholder="'A', 'B', 'Hűtős', stb. " required/>
                    <br>
                    <label class="form-label fw-bold" for="address">Raktár címe</label>
                    <br>
                    <input class="form-control" type="text" id="address" name="address" placeholder="address" required/>
                    <br>
                    <label class="form-label fw-bold" for="capacity">Maximális befogadóképesség kg-ban</label>
                    <br>
                    <input class="form-control" type="number" id="capacity" name="capacity" placeholder="100, 200, 500, stb." required/>
                    <br>
                    <input class="btn btn-primary" type="submit" value="Raktár hozzáadása">
                </form>
                <br>
