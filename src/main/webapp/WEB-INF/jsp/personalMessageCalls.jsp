            ...
            <nav class="sidebar">
                <ul class="nav flex-column p-3">
	                <c:if test="${sessionScope.adminRoleType=='true'}">
	                    ...
	                    <li>
	                        <a class="nav-link sidebar-link" id="current" href="personalMessageCalls">Hirdetmény lista</a>
	                    </li>
	                </c:if>
	                <li class="nav-item">
	                    Üzenetek
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${messages}" var="m">
                        <tr>
                            ...
                            <td>
                                <c:set var = "string1" value = "${m.messageBody}"/>
                                <c:set var = "string2" value = "${fn:substring(string1, 0, 10)}" />
                                ${string2}.........
                            </td>
                            <td>
                                <a onclick='return confirm("Biztosan törölni szeretné a hirdetményt?");' href="personalMessageCalls/delete?id=${m.id}" class="btn btn-danger sm">Törlés</a>
                            </td>
                            <td>
                                <a href="personalMessageCalls/personalMessageCallsUpdate?id=${m.id}" class="btn btn-warning sm">Módosítás</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
