...
<nav class="navbar navbar-expand-md container-fluid navbar-dark bg-dark">
            ...
            <nav class="sidebar">
                <ul class="nav flex-column p-3">
	                <c:if test="${sessionScope.adminRoleType=='true'}">
	                    ...
	                    <li>
	                        <a class="nav-link sidebar-link" href="personalMessageCall">Új Hirdetmény</a>
	                    </li>
	                    <li>
	                        <a class="nav-link sidebar-link" href="personalMessageCalls">Hirdetmény lista</a>
	                    </li>
	                </c:if>
	                <li class="nav-item">
	                    Üzenetek
	                ...
	                <li class="nav-item">
		                <a class="nav-link sidebar-link" id="current" href="/personalMessageNew"> Új üzenet küldése</a>
	                </li>
	                <li class="nav-item">
    ...
    <div class="column col-9 p-3">
        <form action="personalMessageNew" method="post">
            <label class="form-label fw-bold" for="receiver">Címzett: </label>
            <select name="receiver">
                <c:forEach items="${users}" var="u">
                    <option id="receiver" name="receiver" value="${u.displayName}" ${u.displayName == receiver ? 'selected = "selected"' : ''}>${u.displayName}</option>
                </c:forEach>
            </select>
            <br>
            <label class="form-label fw-bold" for="subject">Tárgy</label>
            <input class="form-control" type="text" id="subject" name="subject" placeholder="Tárgy" required>
            <div class="d-flex flex-column">
                <label class="form-label fw-bold my-2" for="messageBody">Üzenet tartalma</label>
                <textarea class="form-controll" id="messageBody" name="messageBody" placeholder="Ide írja a küldeni kívánt üzenetet!" rows="10" cols="50" required></textarea>
            </div>
            <input class="btn btn-primary my-3" type="submit" value="Új üzenet">
        </form>
        <br>
        <a href="/messageHandling">
