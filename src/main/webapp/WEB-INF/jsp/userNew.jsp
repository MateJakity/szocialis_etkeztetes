            ...
            <div class="collapse navbar-collapse" id="navbarToggler">
              ...
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <c:if test="${sessionScope.adminRoleType == 'true'}">
                    <li class="nav-item">
                        <a class="nav-link fs-3 nav-hover  mx-2 mx-lg-2 active" href="/userHandling" >Beállítások</a>
                    </li>
                </c:if>
            ...
            <div class="row">
                <div class="column col-3">
                    <nav class="sidebar">
                        <ul class="nav flex-column p-3">
                            <c:if test="${sessionScope.adminRoleType == 'true'}">
    	                        <li class="nav-item">
    		                        <a class="nav-link sidebar-link" id="current" href="userNew"> Új alkalmazott felvétele</a>
    	                        </li>
	                        <li class="nav-item">
		                        <a class="nav-link sidebar-link" href="userHandling"> Alkalmazottak lista</a>
	                        </li>
    	                    </c:if>
    	                    <li class="nav-item">
    		                    <a class="nav-link sidebar-link" href="userHandling/userUpdate?id=${sessionScope.uid}">Saját beállításaim módosítása</a>
    	                    </li>
                        </ul>
                    </nav>
                </div>
                <div class="column col-9">
                    <div class="container-sm">
                        ...
                        <br>
                        <input class="form-control" type="text" id="displayName" name="displayName" placeholder="Kalapács Béla" required/>
                        <br>
                        <label class="form-label fw-bold" for="userName">Felhasználói név(bejelentkezéshez)</label>
                        <br>
                        <input class="form-control" type="text" id="userName" name="userName" placeholder="kalapacs01" required/>
                        <br>
                        ...
                        <br>
                        <input class="form-control" type="text" id="roleName" name="roleName" placeholder="Szakács, Raktáros, Admin, stb..." required/>
                        <br>
                        <p class="fw-bold">Szeretne-e "admin" jogosultságokat adni az új alkalmazottnak?</p>
                        ...
                        <p class="fw-bold">Szeretne-e "szakács" jogosultságokat adni az új alkalmazottnak?</p>
                        <div class="form-check">
                        ...
                        <input hidden name="active" value="true">
                        <input class="btn btn-primary" type="submit" value="Felvétel">
                        </form>
                        <br>
                        <a href="/userHandling">
