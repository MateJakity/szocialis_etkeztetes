...
<nav class="navbar navbar-expand-md container-fluid navbar-dark bg-dark">
            ...
            <nav class="sidebar">
                <ul class="nav flex-column p-3">
	                <c:if test="${sessionScope.adminRoleType=='true'}">
	                    ...
	                    <li>
	                        <a class="nav-link sidebar-link" id="current" href="personalMessageCall">Új Hirdetmény</a>
	                    </li>
	                    <li>
    ...
    <div class="column col-9">
        <h2>
            Új Hirdetmény intézése
        </h2>
        <form action="personalMessageCall" method="post">
            <input hidden type="text" id="receiver" name="receiver" value="everyone">
            <input hidden class="form-control" type="text" id="subject" name="subject" value="call">
            <div class="d-flex flex-column">
                <textarea class="form-controll" name="messageBody" placeholder="Ide írja a Hirdetmény a tartalmát!" rows="10" cols="50" required></textarea>
            </div>
            <br>
            <input class="btn btn-primary" type="submit" value="Hirdetmény közzététele">
        </form>
        <br>
